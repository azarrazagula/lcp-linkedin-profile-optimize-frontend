...
export default function LoginPage({ onLoginSuccess }) {
  ...
  if (isReturningGoogleUser) {
    return (
      <div className="min-h-screen bg-slate-50 bg-grid-pattern flex flex-col justify-center items-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md backdrop-blur-2xl bg-white/90 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-[0_0_50px_rgba(10,102,194,0.06)] relative z-10 flex flex-col items-center justify-center">
          ...
          {successMsg && (
            <div className="w-full mb-5 p-3.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-semibold flex items-start gap-2.5">
  ...
  return (
    <div className="min-h-screen bg-slate-50 bg-grid-pattern flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      {/* Main Glass Card */}
      <div className="w-full max-w-md backdrop-blur-2xl bg-white/90 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-[0_0_50px_rgba(10,102,194,0.06)] relative z-10 flex flex-col items-center justify-center text-center">
        {/* Brand Icon & Heading */}
